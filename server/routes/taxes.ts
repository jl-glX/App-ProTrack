...
const DEFAULT_TAX_RATES: TaxRate[] = [
  ...
  },
  {
    ...
    percentage: 22,
    description: "Average federal income tax",
  },
  {
    id: "us-income-state",
    country: "US",
    ...
    percentage: 5,
    description: "Average state income tax",
  },
  ...
  },
  {
    ...
    percentage: 10,
    description: "Average provincial income tax",
  },
  ...
  // Spain
  {
    ...
    percentage: 21,
    description: "Spanish standard VAT",
  },
  {
    id: "es-iva-reduced",
    country: "Spain",
    taxType: "IVA (Reduced)",
    percentage: 10,
    description: "Spanish reduced VAT",
  },
  {
    id: "es-income",
    country: "Spain",
    taxType: "Income Tax",
    percentage: 25,
    description: "Average income tax",
  },
  ...
  },
  {
    ...
    taxType: "TVA (Reduced)",
    percentage: 10,
    description: "French reduced VAT",
  },
  {
    id: "fr-income",
    country: "France",
...
taxesRouter.get(
  ...
  async (req: express.Request, res: express.Response) => {
    try {
      ...
      const defaultTaxes = DEFAULT_TAX_RATES.filter(
        (t) => t.country === country,
      );
  ...
  async (_req: express.Request, res: express.Response) => {
    try {
      const countries = Array.from(
        new Set(DEFAULT_TAX_RATES.map((t) => t.country)),
      ).sort();
      res.json(countries);
    } catch (error) {
