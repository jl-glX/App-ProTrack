...
export function CategoryPercentageChart({ categories }: CategoryPercentageChartProps) {
  ...
  return (
    <Card className="p-6">
      <h3 className="text-lg font-semibold mb-4">{t('budget.categories')} {t('charts.percentage')}</h3>
